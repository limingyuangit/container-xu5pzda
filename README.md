...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xu5pzda.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xu5pzda.containers.anotherwebservice.com/
...
```
git clone git@github.com:limingyuangit/container-xu5pzda.git
cd container-xu5pzda
```
...
```
docker attach container-xu5pzda
```
